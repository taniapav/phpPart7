    ...
    <fieldset id="sec">
      ...
      if (isset($_POST['lastname'])) {
        ...
        if (preg_match($r, $_POST['lastname'])) {
          ...
          /* Pour échapper le code HTML, il suffit d'utiliser la fonction htmlspecialcharsqui va transformer les chevrons des balises HTML<>en&lt;et&gt;respectivement.
